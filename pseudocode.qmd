...
There is very great information in the `protocolSection$identificationModule` section such as the ID of the study, the title, and organization.

I plan to extract this information by writing a function that will look at the `protocolSection$identificationModule` for each study (\[\[1\]\], \[\[2\]\], \[\[3\]\], ...) and save subsection (`nctID`, `orgStudyInfo`,...) as a column in a tibble.

Then I'll use `purrr:map_dfr()` to apply this function to each `json_response$studies`, hopefully I can get a nice unlisted table from this. I'll continue to add more study information I find as I explore the json file.
...
After looking at how the raw data is, this is how I'll want to transform the data to be tabular.

![](images/clipboard-1973079156.png)
...
I hope to recreate the same visuals I did in R.
